...
import 'package:ekart/c_dashboard/screens/a_personal_details/b_new_address_screen.dart';
...
class PersonalDetailsScaffold extends HookWidget {
  const PersonalDetailsScaffold({
    super.key,
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Center(
                    child: Stack(
                      children: [
                        personalData['photoURL'].isNotEmpty
                            ? ClipRRect(
                  ...
                  if (personalData['homeAddress'] != null ||
                      personalData['workAddress'] != null)
                    SizedBox(
                      height: 5.h,
                    ),
                  if (personalData['homeAddress'] != null)
                      ...
                      child: Row(
                        ...
                        children: [
                          SizedBox(
                            width: 0.75.sw,
                            child: Text(
                              personalData['homeAddress']['address'] +
                                  ', ' +
                  ...
                  if (personalData['workAddress'] != null)
                    Padding(
                      padding: const EdgeInsets.only(top: 8),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          SizedBox(
                            width: 0.75.sw,
                            child: Text(
                              personalData['workAddress']['address'] +
                                  ', ' +
